...
//   die();
         ...
         $url = 'templates/controller/Controller.html';
         ...
         $url = 'templates/model/Model.html';
         $html = file_get_contents($url);
     ...
     public function getField($key,$type,$required)
     {
         ...
         switch ($type) {
          ...
          <div class="form-group col-md-6 mb-3">
            ...
            <input id="'.$key.'" name="'.$key.'" type="'.$type.'" class="form-control" value="<?=$'.$key.'?>" '.$required.'>
          </div>
          ';
                 break;
          ...
          <div class="form-group col-md-6 mb-3">
            <label for="'.$key.'" class="control-label mb-1">'.ucfirst($key).' </label>
            <textarea id="'.$key.'" name="'.$key.'" type="text" class="form-control"  '.$required.' ><?=$'.$key.'?></textarea>
          </div>
          ';
                 break;
