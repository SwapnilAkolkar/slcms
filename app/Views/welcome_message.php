...
<head>
    <meta charset="UTF-8">
    <title>Welcome to SLCMS 4!</title>
...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo">
                <a href="https://stitpragya.in" target="_blank">
            ...
            <li class="menu-item hidden"><a href="https://slcms.stitpragya.in/user_guide/" target="_blank">Docs</a>
            </li>
            <li class="menu-item hidden"><a href="https://forumslcms.stitpragya.in/" target="_blank">Community</a></li>
            <li class="menu-item hidden"><a
                    href="https://slcms.stitpragya.in/contribute" target="_blank">Contribute</a>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to SLCMS </h1>
        <h5>Powered By CodeIgniter Version <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h5>

        <h2>The Light Smart CMS ...</h2>
...
<section>
    ...
    <p>SLCMS is utility to build the dynmic sites faster with help of inbuilt CRUD builder 
        along with power of CodeIgniter. 
        This comes along with CodeIgniter pre installed. 
        This is first tested on 15 + sites by Stitpragya Technologies. 
        Now it is made available to public. 
        More information can be found at the official site.</p>

    <p>The user guide corresponding to the latest version of the SLCMS can be found <a href="https://slcms.stitpragya.in">here.</a></p>
    <p>You Can Change This Page View From : </p>
...
<div class="further">
    ...
    <section>
        ...
        <p>The User Guide contains an introduction, tutorial, a number of "how to"
            ...
            the framework. Check the <a href="https://slcms.stitpragya.in/user_guide/"
        ...
        <p>SLCMS is a community-developed open source project, with several
             venues for the community members to gather and exchange ideas. View all
             the threads on <a href="https://forum.SLCMS.com/"
             target="_blank">SLCMS's forum</a></p>
        ...
        <p>SLCMS is a community driven project and accepts contributions
             of code and documentation from the community. Why not
             <a href="https://slcms.stitpragya.in/contribute" target="_blank">
             join us</a> ?</p>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> SLCMS Foundation. SLCMS is open source project released under the MIT
